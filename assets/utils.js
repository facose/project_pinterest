...
$('.alternate-home').click(function(){
    $('.mobile-home').toggle();
});

$('.fa-chevron-2').click(function(){
    $('.menu').toggle();
});
...
window.onload = function() {
    ...
    for (let i = 0; i < img_arry.length; i ++) {
        ...
        a1.classList.add("bottom1")
        let a2 = document.createElement('a'); 
        a2.classList.add("bottom2")
    
        
        let gallery = document.getElementById('gallery')

        gallery.appendChild(img_div).appendChild(img)
        img.before(a, a1, a2);
        a.innerHTML += 'Guardar';
        a1.innerHTML += '<i class="fas fa-upload"></i>'
        a2.innerHTML += '<i class="fas fa-ellipsis-h"></i>'
    };
};
